...
SITE_BASE_URL = 'http://localhost:5000' if DEBUG else 'http://floating-river-1678.herokuapp.com'
...
HTTPS_URL = 'http://localhost:5000' if DEBUG else 'https://floating-river-1678.herokuapp.com'
